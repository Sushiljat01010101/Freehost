...
<body>
        ...
        <div class="container">
            ...
            <div class="collapse navbar-collapse" id="navbarNav">
                <ul class="navbar-nav me-auto">
                    ...
                    <li class="nav-item">
                        <a class="nav-link" href="watermark-settings.php" style="color: var(--text-light);">
    ...
    <div class="container mb-5">
        ...
        <div class="row mb-4">
            <div class="col-md-3 mb-3">
                <div class="upload-card h-100" style="cursor: pointer;" onclick="location.href='watermark-settings.php'">
                    <div class="card-body text-center">
            ...
            <div class="col-md-3 mb-3">
                <div class="upload-card h-100" style="cursor: pointer;" onclick="location.href='dashboard.php'">
                    <div class="card-body text-center">
                        <i class="fas fa-cogs" style="font-size: 2rem; color: var(--primary-color);"></i>
                        <h5 class="mt-2" style="color: var(--text-light);">File Manager</h5>
                        <small style="color: var(--text-light); opacity: 0.8;">Manage uploaded files</small>
                    </div>
                </div>
            </div>
            <div class="col-md-3 mb-3">
                <div class="upload-card h-100" style="cursor: pointer;" onclick="location.href='help.php'">
                    <div class="card-body text-center">
                        <i class="fas fa-question-circle" style="font-size: 2rem; color: var(--accent-color);"></i>
                        <h5 class="mt-2" style="color: var(--text-light);">Help & Tutorials</h5>
                        <small style="color: var(--text-light); opacity: 0.8;">Learn how to use</small>
                    </div>
                </div>
            </div>
            <div class="col-md-3 mb-3">
                <div class="upload-card h-100" style="cursor: pointer;" onclick="window.open('https://github.com/sushilchoudhary', '_blank')">
                    <div class="card-body text-center">
                        <i class="fab fa-github" style="font-size: 2rem; color: var(--text-light);"></i>
                        <h5 class="mt-2" style="color: var(--text-light);">GitHub</h5>
                        <small style="color: var(--text-light); opacity: 0.8;">Visit developer profile</small>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="card upload-card animate__animated animate__fadeInUp">
            ...
            <div class="card-body p-4">
                <div class="dropzone mb-4" id="dropzone">
                    ...
                    <p style="color: var(--text-light); opacity: 0.8;">Support करता है HTML, CSS, JS, TXT files और ZIP folders</p>
                    <p class="small" style="color: var(--text-light); opacity: 0.6;">Maximum file size: 5MB | ZIP folders: 20MB | Auto index.html linking</p>
                </div>
                
                <form method="POST" enctype="multipart/form-data" id="uploadForm" action="upload.php">
                    <input type="file" name="file" id="fileInput" class="d-none" required accept=".html,.css,.js,.txt,.zip" multiple>
                    <div class="row">
                        <div class="col-md-8">
                ...
                <div class="row mt-4">
                    ...
                    <div class="col-md-6">
                        ...
                        <div class="d-flex align-items-center mb-2">
                            <i class="fas fa-folder-plus me-2" style="color: var(--secondary-color);"></i>
                            <small style="color: var(--text-light);">ZIP folder uploads with auto index.html</small>
                        </div>
                    </div>
                </div>
            </div>
                                ...
                                <div class="row align-items-center">
                                    ...
                                    <div class="col-md-4">
                                        <?php if (isset($file['public_url'])): ?>
                                            <div class="hosting-link">
                                                <?php if (isset($file['is_folder']) && $file['is_folder'] && isset($file['index_url'])): ?>
                                                    <small class="text-muted d-block">Website URL (index.html):</small>
                                                    <div class="input-group input-group-sm mb-2">
                                                        <input type="text" class="form-control form-control-sm" 
                                                               value="<?php echo htmlspecialchars($file['index_url']); ?>" 
                                                               readonly id="index-url-<?php echo $index; ?>">
                                                        <button class="btn btn-outline-success btn-sm" type="button" 
                                                                onclick="copyToClipboard('index-url-<?php echo $index; ?>')"
                                                                data-bs-toggle="tooltip" title="Copy Website Link">
                                                            <i class="fas fa-external-link-alt"></i>
                                                        </button>
                                                    </div>
                                                    <small class="text-muted d-block">Folder URL:</small>
                                                    <div class="input-group input-group-sm">
                                                        ...
                                                        <button class="btn btn-outline-primary btn-sm" type="button" 
                                                                ...
                                                                data-bs-toggle="tooltip" title="Copy Folder Link">
                                    ...
                                    <div class="col-md-3 text-end">
                                        <div class="btn-group" role="group">
                                            <?php if (isset($file['is_folder']) && $file['is_folder']): ?>
                                                <?php if (isset($file['index_url'])): ?>
                                                    <a href="<?php echo htmlspecialchars($file['index_url']); ?>" 
                                                       class="btn btn-success btn-action" target="_blank" 
                                                       data-bs-toggle="tooltip" title="Open Website">
                                                        <i class="fas fa-external-link-alt"></i>
                                                    </a>
                                                <?php endif; ?>
                                                <a href="<?php echo htmlspecialchars($file['public_url']); ?>" 
                                                   class="btn btn-info btn-action" target="_blank" 
                                                   data-bs-toggle="tooltip" title="Browse Folder">
                                                    <i class="fas fa-folder-open"></i>
                                                </a>
                                                <a href="upload.php?action=delete&file=<?php echo urlencode($file['unique_name']); ?>" 
                                                   class="btn btn-danger btn-action" 
                                                   data-bs-toggle="tooltip" title="Delete Folder"
                                                   onclick="return confirm('Are you sure you want to delete this entire folder?')">
